...
//        currentTime = sdf.format(calendar.getTime());
        ...
        try {
            ...
            if (msgType.equals(MessageUtil.REQ_MESSAGE_TYPE_TEXT)) {
                ...
                switch (member_info.getMember_Function()) {
                    case "register":
                    ...
                    case "addbook": // add ISBN Library_ID
                ...
                if (eventType.equals(MessageUtil.EVENT_TYPE_SUBSCRIBE)) {
                    ...
                    if (eventKey.equals(CommonButton.KEY_LOGIN)) {
                        ...
                        respContent = member_info.getMember_Function().equals("searchbook") ? "回复\"书名\"查询您想要的书本！再次点击可关闭查询功能。" : "书本查询功能已经关闭，可点击按钮重新开启。";
